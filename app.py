...
def load_sample_data():
    ...
    data = [
        # --- [기계 - 베어링류 자재 (대폭 보강)] ---
        {"분류": "기계", "자재명": "볼베어링", "자재규격": "6204zz", "입고단가": 2400, "납품업체": "미기재 (향후 개선 예정)", "입고일자": "2025-01-10", "수량": 40},
        {"분류": "기계", "자재명": "볼베어링", "자재규격": "6205zz", "입고단가": 2850, "납품업체": "미기재 (향후 개선 예정)", "입고일자": "2025-02-15", "수량": 50},
        {"분류": "기계", "자재명": "볼베어링", "자재규격": "6206zz", "입고단가": 3400, "납품업체": "미기재 (향후 개선 예정)", "입고일자": "2025-03-20", "수량": 30},
        {"분류": "기계", "자재명": "볼베어링", "자재규격": "6208zz", "입고단가": 5200, "납품업체": "미기재 (향후 개선 예정)", "입고일자": "2025-04-12", "수량": 20},
        {"분류": "기계", "자재명": "볼베어링", "자재규격": "6210zz", "입고단가": 8900, "납품업체": "미기재 (향후 개선 예정)", "입고일자": "2025-05-19", "수량": 15},
        ...
        {"분류": "기계", "자재명": "볼베어링", "자재규격": "6305zz", "입고단가": 3800, "납품업체": "미기재 (향후 개선 예정)", "입고일자": "2025-06-08", "수량": 30},
        {"분류": "기계", "자재명": "볼베어링", "자재규격": "6308zz", "입고단가": 7200, "납품업체": "미기재 (향후 개선 예정)", "입고일자": "2025-07-14", "수량": 25},
        {"분류": "기계", "자재명": "볼베어링", "자재규격": "6310zz", "입고단가": 12500, "납품업체": "미기재 (향후 개선 예정)", "입고일자": "2025-10-05", "수량": 10},
        
        {"분류": "기계", "자재명": "UC베어링", "자재규격": "UC205", "입고단가": 8300, "납품업체": "미기재 (향후 개선 예정)", "입고일자": "2025-04-15", "수량": 20},
        {"분류": "기계", "자재명": "UC베어링", "자재규격": "UC206", "입고단가": 9800, "납품업체": "미기재 (향후 개선 예정)", "입고일자": "2025-05-11", "수량": 15},
        {"분류": "기계", "자재명": "UC베어링", "자재규격": "UC208", "입고단가": 13500, "납품업체": "미기재 (향후 개선 예정)", "입고일자": "2025-08-22", "수량": 10},
        {"분류": "기계", "자재명": "UCP 베어링유니트", "자재규격": "UCP205", "입고단가": 14200, "납품업체": "미기재 (향후 개선 예정)", "입고일자": "2025-03-30", "수량": 12},
        {"분류": "기계", "자재명": "UCP 베어링유니트", "자재규격": "UCP208", "입고단가": 21500, "납품업체": "미기재 (향후 개선 예정)", "입고일자": "2025-09-02", "수량": 8},
        {"분류": "기계", "자재명": "자동조심 롤러베어링", "자재규격": "22210EK", "입고단가": 42000, "납품업체": "미기재 (향후 개선 예정)", "입고일자": "2025-06-18", "수량": 6},
        {"분류": "기계", "자재명": "앵귤러 볼베어링", "자재규격": "7308B", "입고단가": 28000, "납품업체": "미기재 (향후 개선 예정)", "입고일자": "2025-07-29", "수량": 8},
        ...
        # --- [기계 - 동력전달장치] ---
        {"분류": "기계", "자재명": "더블 피치 체인", "자재규격": "HC2040 1열", "입고단가": 3910, "납품업체": "미기재 (향후 개선 예정)", "입고일자": "2025-02-10", "수량": 10},
        {"분류": "기계", "자재명": "롤러 체인", "자재규격": "HC40 1열", "입고단가": 3740, "납품업체": "미기재 (향후 개선 예정)", "입고일자": "2025-01-15", "수량": 5},
...
def load_price_index_data():
    # 물가지 DB (베어링 품목 추가 및 페이지 연동)
    price_data = [
        {"품목명": "배관용 스텐 파이프", "규격": "STS304 50A", "추천단가": 120000, "출처": "거래가격 2025년 기준", "페이지": "845p"},
        {"품목명": "배관용 스텐 엘보", "규격": "STS304 50A", "추천단가": 8200, "출처": "물가자료 2025년 기준", "페이지": "912p"},
        ...
        # 베어링류 물가지 데이터
        {"품목명": "볼베어링", "규격": "6204ZZ", "추천단가": 2400, "출처": "종합물가정보 2026년 8월호", "페이지": "1118p"},
        {"품목명": "볼베어링", "규격": "6205ZZ", "추천단가": 2850, "출처": "종합물가정보 2026년 8월호", "페이지": "1118p"},
        {"품목명": "볼베어링", "규격": "6206ZZ", "추천단가": 3400, "출처": "물가자료 2025년 기준", "페이지": "1119p"},
        {"품목명": "볼베어링", "규격": "6302ZZ", "추천단가": 2700, "출처": "물가자료 2025년 기준", "페이지": "1120p"},
        {"품목명": "볼베어링", "규격": "6304ZZ", "추천단가": 3100, "출처": "거래가격 2025년 기준", "페이지": "1122p"},
        {"품목명": "볼베어링", "규격": "6305ZZ", "추천단가": 3800, "출처": "종합물가정보 2026년 8월호", "페이지": "1123p"},
        {"품목명": "UC베어링", "규격": "UC205", "추천단가": 8300, "출처": "물가자료 2025년 기준", "페이지": "1140p"},
        {"품목명": "UC베어링", "규격": "UC206", "추천단가": 9800, "출처": "거래가격 2025년 기준", "페이지": "1141p"},
        {"품목명": "UCP 베어링유니트", "규격": "UCP205", "추천단가": 14200, "출처": "종합물가정보 2026년 8월호", "페이지": "1152p"},
        
        {"품목명": "배관용 스텐볼밸브", "규격": "15A 나사식", "추천단가": 3800, "출처": "거래가격 2025년 기준", "페이지": "530p"},
        {"품목명": "고분자응집제", "규격": "중앙이온", "추천단가": 120000, "출처": "물가자료 2025년 기준", "페이지": "415p"},
    ]
...
if selected_menu == "🔍 단 품목 단가 검증":
    ...
    with col_search:
        search_input = st.text_input("🔍 자재명 또는 규격 검색", value=default_search_val, placeholder="예: 베어링, 6205, 6302, 파이프, 체인")
    ...
    if item_records is not None and not item_records.empty:
        ...
        if ref_result is not None and not ref_result.empty:
            for _, ref in ref_result.iterrows():
                page_str = f" | 📄 **페이지: {ref['페이지']}**" if '페이지' in ref and pd.notna(ref['페이지']) else ""
                st.success(
                    f"✅ **[물가지 매칭 성공]** 추천 단가: **{ref['추천단가']:,} 원** "
                    f"(출처: {ref['출처']}{page_str} / 규격: {ref['규격']})"
                )
        else:
